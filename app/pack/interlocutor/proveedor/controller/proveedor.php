...
class Proveedor extends Interlocutor {
    ...
    public function __construct($db = "", $modulo = "") {
        ...
        $campos_formulario['interlocutor_clase_id'] = array('tipo' => 'hidden', 'valor' => CLASE_PROVEEDOR, 'complemento' => '');
        ...
        $campos_formulario['telefono'] = array('tipo' => 'number', 'valor' => '', 'complemento' => 'required minlength="7" maxlength="10"', 'label'=>'Teléfono');
        $campos_formulario['estado_id'] = array('tipo' => 'select', 'valor' => '1', 'tabla' => 'fw_estado', 'complemento' => '', 'campo' => 'descripcion', 'condicion' => 'id_estado IN (1,2)', 'tag' => 'select');
    ...
    function home() {
        ...
        $condicion = 'itc.interlocutor_id=' . $interlocutor_id_actual . ''
                . ' AND i.interlocutor_clase_id = '.CLASE_PROVEEDOR
