...
var VKI_attach, VKI_close;
  function VKI_buildKeyboardInputs() {
    ...
    this.VKI_imageURI = "controlador/js/lib/keyboard/keyboard.png";
    ...
    this.VKI_i18n = {
      ...
      '02': "Seleccione configuración por pais",
      '03': "Teclas muertas",
      '04': "Activo",
      '05': "Inactivo",
    ...
    this.VKI_attachKeyboard = VKI_attach = function(elem){
      ...
      var keybut = document.createElement('img');
          ...
          keybut.elem = elem;
      var onclickEvent =     function() { self.VKI_show(this.elem); };
      //    keybut.onclick = function() { self.VKI_show(this.elem); };
          keybut.onclick = onclickEvent;
         // elem.onfocus = function() { keybut.VKI_show(this.elem); };
...
//    this.VKI_keyboard.onmouseout = function() { alert("out");};//self.VKI_close(); };
 //   this.VKI_keyboard.onmouseover = function() { alert("over");};
    ...
    this.VKI_insert = function(text) {
      ...
      if (typeof this.VKI_target.maxlength == "undefined" ||
        ...
        if (this.VKI_target.setSelectionRange) {
          ...
          var value_old = this.VKI_target.value;
          this.VKI_target.value = value_old + text;
          if (text == "\n" && window.opera) rng[0]++;
  ...
  /* ************ Close the keyboar onblur ************************** */
  function elementBlur(element){
    if($(element).className == "keyboardInput")
        this.VKI_close();  
  }
  function elementFocusLogin(element){
    if(element == "usuario" || element == "captcha")
        this.VKI_close(); 
